...
function addon:OnInitialize()
	...
	self:InitializeModule(defaults, eframe) -- InitializeModule expects a frame to add a default event handler to. You don't have to use initializemodule, see XLoot\XLoot.lua
	opt = self.db.profile
