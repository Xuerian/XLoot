	...
	if not BlizOptions[appName][key] then
		...
		if Settings and Settings.RegisterCanvasLayoutCategory then
			...
			if parent then
				...
				-- [PATCH 12.0] Capture numeric ID before overwriting with string name.
				-- Settings.OpenToCategory requires a number in Midnight.
				local numericCategoryID = category.ID
				category.ID = categoryName
				group.frame.categoryID = numericCategoryID
