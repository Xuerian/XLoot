...
local locales = {
	enUS = {
		...
		Frame = {
			...
			speedy_autoloot_skip_fishing = "Leave fishing catches alone",
			speedy_autoloot_skip_fishing_desc = "Let fishing loot open the normal loot window instead of being speedy-looted. Speedy can empty the bobber before a fishing tracker addon has read the catch, so turn this on if one is missing fish. Everything else still speedy-loots as usual.",
			...
			loot_color_quest = "Quest item color",
			loot_color_quest_desc = "The color quest items are painted. Only used while \"Color quest items\" is on and \"Use my class color\" is off.",
			...
			quest_color_slot = "Color quest items",
			quest_color_slot_desc = "Paint the name and border of quest items in their own color so they stand out when the loot window opens. Covers both quest-type items and ordinary items your active quests ask you to collect. Overrides the quality coloring on those rows.",
			quest_color_class = "Use my class color",
			quest_color_class_desc = "Color quest items with your own class color instead of the color set in \"Quest item color\".",
		...
		Monitor = {
			...
			quest_color = "Color quest items",
			quest_color_desc = "Paint the name and border of quest items in the loot feed so they stand out, the same way the loot window colors them. Covers both quest-type items and ordinary items your active quests ask you to collect, and overrides the quality coloring on those rows. Only your own loot is colored, and only items that pass through a loot window - a quest reward handed straight to your bags is not. Quest items are shown even when they fall below the quality thresholds above, so the feature still works on a default profile.",
			quest_color_class = "Use my class color",
			quest_color_class_desc = "Color quest items with your own class color instead of the color set in \"Quest item color\".",
			monitor_color_quest = "Quest item color",
			monitor_color_quest_desc = "The color quest items are painted in the loot feed. Only used while \"Color quest items\" is on and \"Use my class color\" is off.",
