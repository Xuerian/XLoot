...
--@localization(locale="ptBR", format="lua_additive_table", table-name="locales.ptBR", handle-unlocalized="ignore", namespace="Options")@
--@localization(locale="frFR", format="lua_additive_table", table-name="locales.frFR", handle-unlocalized="ignore", namespace="Options")@
--@localization(locale="deDE", format="lua_additive_table", table-name="locales.deDE", handle-unlocalized="ignore", namespace="Options")@
--@localization(locale="koKR", format="lua_additive_table", table-name="locales.koKR", handle-unlocalized="ignore", namespace="Options")@
--@localization(locale="esMX", format="lua_additive_table", table-name="locales.esMX", handle-unlocalized="ignore", namespace="Options")@
--@localization(locale="ruRU", format="lua_additive_table", table-name="locales.ruRU", handle-unlocalized="ignore", namespace="Options")@
--@localization(locale="zhCN", format="lua_additive_table", table-name="locales.zhCN", handle-unlocalized="ignore", namespace="Options")@
--@localization(locale="esES", format="lua_additive_table", table-name="locales.esES", handle-unlocalized="ignore", namespace="Options")@
--@localization(locale="zhTW", format="lua_additive_table", table-name="locales.zhTW", handle-unlocalized="ignore", namespace="Options")@
