...
local locales = {
	enUS = {
		...
		Frame = {
			...
			autoloot_gear_quality_desc = "Only auto loot gear of this quality or higher",
			...
			autoloot_value_minprice_desc = "Only auto loot items whose total vendor value is at least this many gold",
