...
local locales = {
	enUS = {
		Core = {
			...
			whatsnew = "Show What's New popup",
			whatsnew_desc = "Show a short summary of new features after an update. Permanently disables the What's New popup when turned off; you can turn it back on here.",
